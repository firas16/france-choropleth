# France Choropleth [![Build Status](https://travis-ci.org/sylvaindurand/france-choropleth.svg?branch=gh-pages)](https://travis-ci.org/sylvaindurand/france-choropleth)
